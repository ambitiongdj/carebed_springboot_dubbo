...
$(document).ready(function(){
	...
	jQuery.validator.addMethod("gtAmount", function (value, element,param) {
		console.log(value  + "-- " + param + "-- " + (value > parseInt(param)));
		return value >= parseInt(param);
	}, $.validator.format("起投金额必须大于等于{0}万元"));
	jQuery.validator.addMethod("itAmount", function (value, element,param) {
		return value < parseInt(param);
	}, $.validator.format("输入金额必须小于{0}万元"));
