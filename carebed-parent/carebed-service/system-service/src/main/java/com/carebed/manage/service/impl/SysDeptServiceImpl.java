...
import com.carebed.manage.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    @Override
    public List<Ztree> getOrderTreeData(Map<String, Object> param) {
        List<SysDept> deptList = deptMapper.getOrderTreeData(param);
        List<Ztree> ztrees = initZtree(deptList);
        return ztrees;
    }
	@Override
	public SysDept findDeptByDeptCode(String deptCode) {
		return deptMapper.findDeptByDeptCode(deptCode);
	}

    @Override
    public String checkDeptCodeUnique(SysDept dept) {
        int uniqueNum = deptMapper.checkDeptCodeUnique(dept);
        if(uniqueNum > 0){
